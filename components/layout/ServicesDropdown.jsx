...
const ServicesDropdown = () => {
  return (
    <div className="relative group">
      ...
      <div className="
      absolute left-1/2 -translate-x-1/2 top-10 w-[95vw] md:w-[700px] lg:w-[1000px] xl:w-[1200px] bg-white p-5 md:p-6
      shadow-xl rounded z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ">

        <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-10 text-black text-[15px] ">
